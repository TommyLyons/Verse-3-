...
export default function Home() {
  ...
  return (
    <div className="flex flex-col">
      ...
      {/* Hero Section - Buttons strictly moved to the bottom third */}
      <section className="relative w-full h-[75vh] md:h-[85vh] flex flex-col items-center justify-end overflow-hidden pb-12 md:pb-24">
        <video
